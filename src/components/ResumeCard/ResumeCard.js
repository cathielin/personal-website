...
const ResumeCard = () => {
  return (
    <CenterCard title="resume">
      <ModalSection title="education">
        <div>
          ★ <b>University of California, Berkeley </b>
          <br />★ <b>Electrical Engineering and Computer Science</b> <br />
          ★ expected grad: June 2023 <br />★ 3.6/4.0 gpa
        </div>
      </ModalSection>
      ...
      <ModalSection title="programming languages">
