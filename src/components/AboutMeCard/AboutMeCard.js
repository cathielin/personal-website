        ...
        <div className="text">
          <ModalSection title="the basics">
            <div>
              ...
              studying Electrical Engineering and Computer Science and also an
          ...
          <ModalSection title="a quick history">
            <div>
              ...
              HTML/CSS templates to customize my petpages on neopets.com. I
              later learned how to code seriously in high school and self-taught
              myself React in college. I attended UC Davis for my first two
              years of college where I also studied computer science, before
              transferring to UC Berkeley in the fall of 2021.
            </div>
          </ModalSection>
        </div>
        <div className="image">
      ...
      <ModalSection title="stats">
        <div className="double-list">
          ...
          <div className="right-list">
            ...
            ★ favorite color: green <br />★ mbti: enfp
          </div>
        </div>
      </ModalSection>
